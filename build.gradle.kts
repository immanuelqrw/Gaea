...
val projectGroup = "com.immanuelqrw.gaea"
val projectArtifact = "gaea-api"
...
application {
    mainClassName = "com.immanuelqrw.gaea.api.ApplicationKt"
}
...
sonarqube {
    properties {
        ...
        property("sonar.projectKey", "immanuelqrw_Gaea")
        property("sonar.projectName", "Gaea")
...
publishing {
    repositories {
        maven {
            name = "GitHubPackages"
            url = uri("https://maven.pkg.github.com/immanuelqrw/Gaea")
            credentials {
